...
describe ProposalsHelper, type: :helper do
  ...
  describe '#format_icon' do
    it 'displays a formatted icon' do
      ...
      # expect(format_icon('15-minute Presentation')).to include 'handshake-angle'
      ...
      expect(format_icon('Workshop')).to include 'handshake-angle'
      expect(format_icon('15-minute Talk/Demo')).to include 'user'
      ...
      expect(format_icon('Lunchtime Working Session')).to include 'pot-food'
