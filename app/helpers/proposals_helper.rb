...
def parse_format(format)
  format_map = {
    ...
    '45-minute DIY Session': 'hands-holding-circle',
    '90-minute Workshop': 'handshake-angle',
    'Three-hour Workshop': 'handshake-angle',
    '45-minute Working Session': 'laptop-file',
    '45-minute Working Group Session': 'laptop-file',
    'Poster': 'map',
    '5-minute Lightning Talk': 'bolt',
    '2-minute Lightning Talk/Poster': 'bolt',
    '5-minute Demonstration Video': 'video',
